...
export default function ChatPage() {
  ...
  return (
    <div className="flex min-h-[70vh] min-w-0 flex-col">
      {/* Header */}
      <div className="flex-shrink-0 bg-granite-800 border-b border-granite-700 px-3 py-4 sm:px-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-white">Chat Management</h1>
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col md:flex-row overflow-hidden">
        {/* Chat Sessions Sidebar */}
        <div className={`${currentSession ? 'hidden md:flex' : 'flex'} w-full md:w-80 lg:w-1/3 bg-granite-800 border-r border-granite-700 flex-col min-h-[50vh] md:min-h-0`}>
          {/* Sessions Header */}
        ...
        {/* Chat Area */}
        <div className={`${currentSession ? 'flex' : 'hidden md:flex'} min-w-0 flex-1 flex-col`}>
          {currentSession ? (
            <>
              {/* Chat Header */}
              <div className="flex-shrink-0 bg-granite-800 border-b border-granite-700 px-3 py-4 sm:px-6">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex min-w-0 items-center space-x-3">
                    <button
                      type="button"
                      className="md:hidden inline-flex h-9 w-9 items-center justify-center rounded-md text-gray-300 hover:bg-granite-700 hover:text-white"
              ...
              {/* Messages Area */}
              <div className="flex-1 overflow-y-auto bg-granite-900 p-3 sm:p-6 space-y-4">
                {messages.map((msg) => (
                  <div
                    key={msg.id}
