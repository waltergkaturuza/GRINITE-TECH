...
export default function MobileAppsPage() {
  ...
  return (
    <div className="relative min-h-screen bg-granite-900 text-white">
      <Navigation />
        ...
        <main className="relative z-10 pt-28 pb-20">
          <div className="wide-container px-4 sm:px-6 lg:px-8">
            <section className="grid gap-10 lg:grid-cols-2 items-start mb-16">
              <div className="drop-shadow-[0_2px_16px_rgba(0,0,0,0.55)]">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link
                    href="/services"
                    className="inline-flex items-center px-6 py-3 rounded-xl border border-white/25 bg-black/35 text-sm hover:bg-black/50 transition-colors"
                  >
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur-sm">
            ...
            <section className="border border-white/10 rounded-2xl p-6 sm:p-8 bg-gradient-to-r from-jungle-900/80 to-granite-900/80 backdrop-blur-sm">
