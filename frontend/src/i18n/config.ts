...
export const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'nav.portfolio.skills': 'Technical Skills',
    'nav.portfolio.featured': 'Featured Work',
    'nav.portfolio.experience': 'Experience & Approach',
    'nav.portfolio.partner': 'Partner With Quantis',
    'nav.about': 'About',
    'nav.contact': 'Contact',
    ...
    'news.subscribe.title': 'Subscribe to news briefs',
    'news.subscribe.blurb': 'Get an email automatically when we publish a news item or update.',
    ...
    'footer.sitemap.caseStudies': 'Case Studies',
    ...
    'footer.services.fuel': 'Fuel Management',
  ...
  fr: {
    ...
    'nav.news': 'Actualités',
    'nav.portfolio': 'Portfolio',
    'nav.portfolio.skills': 'Compétences techniques',
    'nav.portfolio.featured': 'Travaux phares',
    'nav.portfolio.experience': 'Expérience et approche',
    'nav.portfolio.partner': 'Partenariat avec Quantis',
    'nav.about': 'À propos',
    'nav.contact': 'Contact',
    ...
    'footer.sitemap.caseStudies': 'Études de cas',
    ...
    'footer.services.fuel': 'Gestion du carburant',
  ...
  zh: {
    ...
    'nav.news': '新闻',
    'nav.portfolio': '案例',
    'nav.portfolio.skills': '技术能力',
    'nav.portfolio.featured': '精选项目',
    'nav.portfolio.experience': '经验与方法',
    'nav.portfolio.partner': '与 Quantis 合作',
    'nav.about': '关于我们',
    'nav.contact': '联系',
  ...
  sn: {
    ...
    'nav.news': 'Nhau',
    'nav.portfolio': 'Portfolio',
    'nav.portfolio.skills': 'Hunyanzvi hwehunyanzvi',
    'nav.portfolio.featured': 'Basa rakasarudzwa',
    'nav.portfolio.experience': 'Ruzivo nemaitiro',
    'nav.portfolio.partner': 'Shanda neQuantis',
    'nav.about': 'Nezvedu',
    ...
    'footer.sitemap': 'Mepu yesaiti',
    'footer.sitemap.caseStudies': 'Zvidzidzo zvemitambo',
    'footer.services.web': 'Web Development',
    'footer.services.mobile': 'Mobile Apps',
    'footer.services.digital': 'Digital Products',
    'footer.services.automation': 'Automation',
  ...
  pt: {
    ...
    'nav.portfolio.skills': 'Competências técnicas',
    'nav.portfolio.featured': 'Trabalho em destaque',
    'nav.portfolio.experience': 'Experiência e abordagem',
    'nav.portfolio.partner': 'Parceria com a Quantis',
    'nav.about': 'Sobre',
    ...
    'footer.sitemap.caseStudies': 'Estudos de caso',
    ...
    'footer.services.fuel': 'Gestão de combustível',
  ...
  ja: {
    ...
    'nav.portfolio.skills': '技術スキル',
    'nav.portfolio.featured': '注目の実績',
    'nav.portfolio.experience': '経験とアプローチ',
    'nav.portfolio.partner': 'Quantisと提携',
    'nav.about': '会社概要',
    'nav.contact': 'お問い合わせ',
  ...
  ru: {
    ...
    'nav.portfolio.skills': 'Технические навыки',
    'nav.portfolio.featured': 'Избранные работы',
    'nav.portfolio.experience': 'Опыт и подход',
    'nav.portfolio.partner': 'Партнёрство с Quantis',
    ...
    'footer.sitemap.caseStudies': 'Кейсы',
    ...
    'footer.services.fuel': 'Управление топливом',
  ...
  el: {
    ...
    'nav.news': 'Νέα',
    'nav.portfolio': 'Portfolio',
    'nav.portfolio.skills': 'Τεχνικές δεξιότητες',
    'nav.portfolio.featured': 'Επιλεγμένα έργα',
    'nav.portfolio.experience': 'Εμπειρία και προσέγγιση',
    'nav.portfolio.partner': 'Συνεργασία με την Quantis',
    'nav.about': 'Σχετικά',
    ...
    'footer.sitemap': 'Χάρτης ιστοτόπου',
    'footer.sitemap.caseStudies': 'Μελέτες περίπτωσης',
    'footer.services.web': 'Web Development',
    'footer.services.mobile': 'Mobile Apps',
    'footer.services.digital': 'Digital Products',
    'footer.services.automation': 'Automation',
    'footer.services.fuel': 'Διαχείριση καυσίμων',
    'footer.products.templates': 'Templates',
    'footer.products.tools': 'Tools',
    'footer.products.apis': 'APIs',
    'footer.products.plugins': 'Plugins',
