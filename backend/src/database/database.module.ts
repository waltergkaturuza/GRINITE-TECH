      ...
      useFactory: (configService: ConfigService) => {
        ...
        if (isProduction) {
          ...
          return {
            ...
            entities: [User, Project, Milestone, ProjectModule, Feature, ProjectType, Product, Payment, ChatSession, ProjectRequest, RequestDocument, RequestMessage, MessageAttachment],
